...
""" Methodology of this program:
     One get request and multiple post requests for each user invoked. 
     More like a person hits a URL opens a website and then enter some detials to get some response continously with the time interval from wait_time.
    WORKING OF on_start:
...
class Tasks(SequentialTaskSet):
    ...
    @task
    def first_task(self):
        #print('Calling first_task !!!', self.generated_sid)
        url = ''
